...
function Start() {
  ...
  wget --no-check-certificate -qO /tmp/InstallNET.sh 'https://raw.githubusercontent.com/zyings/DDscript/master/InstallNET.sh' && chmod a+x /tmp/InstallNET.sh
